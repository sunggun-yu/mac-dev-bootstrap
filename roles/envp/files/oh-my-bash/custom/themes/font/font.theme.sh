...
# Overriding Font theme with envp prompt
...
function _omb_theme_PROMPT_COMMAND() {
    ...
    PS1="$(clock_prompt)$python_venv${hostname} ${_omb_prompt_bold_teal}\W $(scm_prompt_char_info)${ret_status} ${_omb_prompt_green}$(envp_prompt_info)→ ${_omb_prompt_normal}"
}
